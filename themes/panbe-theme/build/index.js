...
class Like {
  ...
  async manageLike(action, data) {
    try {
      axios__WEBPACK_IMPORTED_MODULE_0__["default"].defaults.headers.common["X-WP-Nonce"] = panbe_data.nonce;
  ...
  async createLike(currentLikeBox) {
    const likeData = await this.manageLike('post', {
      'tutorId': currentLikeBox.dataset.tutor
    });
...
class MyNotes {
  ...
  async deleteNote(e) {
    ...
    try {
      ...
      const response = await axios__WEBPACK_IMPORTED_MODULE_0__["default"].delete(panbe_data.root_url + "/wp-json/wp/v2/note/" + noteId);
  ...
  async updateNote(e) {
    ...
    try {
      const noteId = thisNote.getAttribute('data-id');
      const response = await axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(panbe_data.root_url + "/wp-json/wp/v2/note/" + noteId, updatedPost);
    } catch (e) {
      console.log('sorry');
    } finally {
      this.cancelEditing(e);
  ...
  async saveNewNote(e) {
    ...
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(panbe_data.root_url + "/wp-json/wp/v2/note/", newPost);
...
class Search {
  ...
  getResults() {
    fetch(`${panbe_data.root_url}/wp-json/panbe/v1/search?term=${this.searchField.value}`).then(response => response.json()).then(results => {
      this.resultDiv.innerHTML = `
                <div class="container">
                    <div class="row">
                        <div class="card" style="width: 18rem;">
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_Search_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/Search.js */ "./src/modules/Search.js");
/* harmony import */ var _modules_MyNotes_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/MyNotes.js */ "./src/modules/MyNotes.js");
/* harmony import */ var _modules_Like_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/Like.js */ "./src/modules/Like.js");



const myNotes = new _modules_MyNotes_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
const like = new _modules_Like_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
document.addEventListener('DOMContentLoaded', () => {
  const search = new _modules_Search_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
});
/******/ })()
;
